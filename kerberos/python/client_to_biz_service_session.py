...
class ClientToBizServiceSession:
    ...
    def generate_session(self, client_id, client_ip, timestamp, server_name):
        session_content = f"{client_id},{client_ip},{timestamp},{server_name}"
    ...
    def parse_session(self, encrypted_session):
        ...
        client_id, client_ip, timestamp, server_name = decrypted_session.split(',')
        return client_id, client_ip, timestamp, server_name