...
class ClientToBizServiceSession:
    ...
    def generate_session(self, client_name, client_ip, timestamp, server_ip):
        session_content = f"{client_name},{client_ip},{timestamp},{server_ip}"
    ...
    def parse_session(self, encrypted_session):
        ...
        client_name, client_ip, timestamp, server_ip = decrypted_session.split(',')
        return client_name, client_ip, timestamp, server_ip